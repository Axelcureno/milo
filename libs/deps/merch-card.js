...
`,E=()=>{let f=[y`
    ...
    `),f};var[z,C,$,S,A,B]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var R=document.createElement("style");R.innerHTML=`
:root {
